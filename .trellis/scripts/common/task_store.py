...
_SEED_EXAMPLE = (
    ...
    "Run `python3.9 .trellis/scripts/get_context.py --mode packages` to list available specs. "
...
def cmd_set_branch(args: argparse.Namespace) -> int:
    ...
    if not branch:
        ...
        print("Usage: python3.9 task.py set-branch <task-dir> <branch-name>")
        return 1
...
def cmd_set_base_branch(args: argparse.Namespace) -> int:
    ...
    if not base_branch:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: python3.9 task.py set-base-branch <task-dir> <base-branch>")
        print("Example: python3.9 task.py set-base-branch <dir> develop")
        print()
...
def cmd_set_scope(args: argparse.Namespace) -> int:
    ...
    if not scope:
        print(colored("Error: Missing arguments", Colors.RED))
        print("Usage: python3.9 task.py set-scope <task-dir> <scope>")
        return 1
