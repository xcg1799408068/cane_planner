...
Usage (called automatically by task.py hooks):
    python3.9 .trellis/scripts/hooks/linear_sync.py create
    python3.9 .trellis/scripts/hooks/linear_sync.py start
    python3.9 .trellis/scripts/hooks/linear_sync.py archive

Manual usage:
    TASK_JSON_PATH=.trellis/tasks/<name>/task.json python3.9 .trellis/scripts/hooks/linear_sync.py sync
