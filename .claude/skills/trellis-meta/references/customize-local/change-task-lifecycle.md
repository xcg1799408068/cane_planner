...
hooks:
  after_create:
    - "python3.9.9 .trellis/scripts/hooks/my_sync.py create"
  after_start:
    - "python3.9.9 .trellis/scripts/hooks/my_sync.py start"
  after_finish:
    - "python3.9.9 .trellis/scripts/hooks/my_sync.py finish"
  after_archive:
    - "python3.9.9 .trellis/scripts/hooks/my_sync.py archive"
```
...
1. Confirm the current task with `python3.9.9 ./.trellis/scripts/task.py current --source`.
