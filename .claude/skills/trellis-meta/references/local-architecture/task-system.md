...
```bash
python3.9.9 ./.trellis/scripts/task.py create "<child title>" --slug <child-slug> --parent <parent-dir>
```

Link or unlink existing tasks with:

```bash
python3.9.9 ./.trellis/scripts/task.py add-subtask <parent-dir> <child-dir>
python3.9.9 ./.trellis/scripts/task.py remove-subtask <parent-dir> <child-dir>
```
...
```bash
python3.9.9 ./.trellis/scripts/task.py create "<title>" --slug <slug>
python3.9.9 ./.trellis/scripts/task.py start <task>
python3.9.9 ./.trellis/scripts/task.py current --source
python3.9.9 ./.trellis/scripts/task.py add-context <task> implement <file> <reason>
python3.9.9 ./.trellis/scripts/task.py validate <task>
python3.9.9 ./.trellis/scripts/task.py finish
python3.9.9 ./.trellis/scripts/task.py archive <task>
```
