...
```bash
python3.9.9 ./.trellis/scripts/get_context.py
```
...
```bash
python3.9.9 ./.trellis/scripts/get_context.py --mode phase
```
...
```bash
python3.9.9 ./.trellis/scripts/get_context.py --mode phase --step <X.X> --platform claude
```
